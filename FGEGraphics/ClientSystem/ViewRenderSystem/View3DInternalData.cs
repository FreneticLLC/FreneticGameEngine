...
{
    /// <summary>
    /// Data internally used by <see cref="View3D"/>.
    /// </summary>
    public class View3DInternalData
    {
        ...
        /// <summary>
        /// Transparency FrameBufferObject color texture.
        /// </summary>
        public int FBO_Transparents_Texture;

        /// <summary>
        /// Transparency FrameBufferObject depth texture.
        /// </summary>
        ...
        /// <summary>
        /// Current transparent textures for the Linked-List transparency trick.
        /// </summary>
        public int[] LL_TransparentTextures = new int[4];

        /// <summary>
        /// Tracks the result of a calculation on <see cref="View3DState.PreviousForward"/> from the previous frame.
        /// </summary>
        public Vector2 PreviousPFResult;

        /// <summary>
        /// FrameBufferObject used for DynamicExposure calculation.
        /// </summary>
        public int FBO_DynamicExposure;

        /// <summary>
        /// FrameBufferObject texture used for DynamicExposure calculation.
        /// </summary>
        public int FBO_DynamicExposure_Texture;

        /// <summary>
        /// Main FrameBufferObject texture.
        /// </summary>
        ...
        /// <summary>
        /// God-Ray FrameBufferObject.
        /// </summary>
        public int FBO_GodRay_Main;
        /// <summary>
        /// God-Ray FrameBufferObject texture.
        /// </summary>
        public int FBO_GodRay_Texture;
        /// <summary>
        /// God-Ray FrameBufferObject second texture.
        /// </summary>
        public int FBO_GodRay_Texture_2;

        /// <summary>
        /// Decals FrameBufferObject.
        /// </summary>
        public int FBO_Decal;

        /// <summary>
        /// Decals FrameBufferObject depth texture.
        /// </summary>
        public int FBO_Decal_Depth;

        /// <summary>
        /// Decals FrameBufferObject texture.
        /// </summary>
        public int FBO_Decal_Texture;

        /// <summary>
        /// Shadow FrameBufferObject.
        /// </summary>
        public int[] FBO_Shadow = new int[SHADOW_BITS_MAX + 1];
        /// <summary>
        /// Shadow FrameBufferObject depth texture.
        /// </summary>
        public int FBO_Shadow_DepthTexture;
        /// <summary>
        /// Shadow FrameBufferObject color texture.
        /// </summary>
        ...
        /// <summary>
        /// The current FBO, as tracked by <see cref="View3D.BindFramebuffer(FramebufferTarget, int)"/>.
        /// </summary>
        public int LastBoundFramebuffer;

        /// <summary>
        /// Helper array to calculate dynamic exposure result data.
        /// </summary>
