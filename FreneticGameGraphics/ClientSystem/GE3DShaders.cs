    ...
    public class GE3DShaders
    {
        ...
        public void LoadAll(ShaderEngine Shaders, bool AllowLL, bool forNorm, bool forLight, bool forShad)
        {
            ...
            string forw_extra = (forNorm ? ",MCM_NORMALS" : "")
                + (forLight ? ",MCM_LIGHTS" : "")
                + (forShad ? ",MCM_SHADOWS" : "");
            Forward.s_forw = Shaders.GetShader("forward" + def + forw_extra);
            Forward.s_forw_nobones = Shaders.GetShader("forward" + def + ",MCM_NO_BONES" + forw_extra);
            Forward.s_forw_trans = Shaders.GetShader("forward" + def + ",MCM_TRANSP" + forw_extra);
            Forward.s_forw_trans_nobones = Shaders.GetShader("forward" + def + ",MCM_TRANSP,MCM_NO_BONES" + forw_extra);
            if (AllowLL)
            {
            ...
            Forward.s_post_fast = Shaders.GetShader("postfast" + def);
            Forward.s_forw_grass = Shaders.GetShader("forward" + def + ",MCM_GEOM_ACTIVE,MCM_GEOM_THREED_TEXTURE" + forw_extra + "?grass");
            Forward.s_fbo_grass = Shaders.GetShader("fbo" + def + ",MCM_GEOM_ACTIVE,MCM_PRETTY,MCM_GEOM_THREED_TEXTURE?grass");
            ...
            Forward.s_forw_particles = Shaders.GetShader("forward" + def + ",MCM_GEOM_ACTIVE,MCM_TRANSP,MCM_BRIGHT,MCM_NO_ALPHA_CAP,MCM_FADE_DEPTH" + forw_extra + "?particles");
            Deferred.s_fbodecal = Shaders.GetShader("fbo" + def + ",MCM_INVERSE_FADE,MCM_NO_ALPHA_CAP,MCM_GEOM_ACTIVE,MCM_PRETTY?decal");
            Forward.s_forwdecal = Shaders.GetShader("forward" + def + ",MCM_INVERSE_FADE,MCM_NO_ALPHA_CAP,MCM_GEOM_ACTIVE" + forw_extra + "?decal");
            Forward.s_forwt_nofog = Shaders.GetShader("forward" + def + ",MCM_NO_ALPHA_CAP,MCM_BRIGHT,MCM_NO_BONES" + forw_extra);
            Forward.s_forwt_obj = Shaders.GetShader("forward" + def + ",MCM_NO_BONES" + forw_extra);
            Forward.s_forwt = Shaders.GetShader("forward" + def + ",MCM_NO_ALPHA_CAP,MCM_BRIGHT,MCM_NO_BONES,MCM_SKY_FOG" + forw_extra);
